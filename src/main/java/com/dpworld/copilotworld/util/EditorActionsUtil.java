...
import com.dpworld.copilotworld.actions.AskAction;
import com.dpworld.copilotworld.actions.BaseEditorAction;
import com.dpworld.copilotworld.actions.CustomPromptAction;
import com.dpworld.copilotworld.actions.IncludeFilesInContextAction;
...
public class EditorActionsUtil {
        ...
        var action = new BaseEditorAction(label, label) {
          ...
          protected void actionPerformed(Project project, Editor editor, String selectedText) {
            ...
            message.setReferencedFilePaths(
                Stream.ofNullable(project.getUserData(AvatarKeys.SELECTED_FILES))
  ...
  public static String convertToId(String label) {
    return "avatar." + CaseUtils.toCamelCase(label, true);
  }
}
