...
public class OverlayUtil {
    ...
    public static final String NOTIFICATION_GROUP_ID = "Avatar Notification Group";
    public static final String NOTIFICATION_GROUP_STICKY_ID = "Avatar Notification Group Sticky";
    ...
    public static Notification getDefaultNotification(
        ...
        var notification = new Notification(NOTIFICATION_GROUP_ID, "Avatar", content, type);
    ...
    public static Notification getStickyNotification(
            @NotNull String content, @NotNull NotificationType type, @NotNull AnAction... actions) {
        var notification = new Notification(NOTIFICATION_GROUP_STICKY_ID, "Avatar", content, type);
        Arrays.asList(actions).forEach(notification::addAction);
        return notification;
    }
    ...
    public static int showDeleteConversationDialog() {
        return Messages.showYesNoDialog(
                AvatarBundle.get("dialog.deleteConversation.description"),
                AvatarBundle.get("dialog.deleteConversation.title"),
                Icons.Default);
    }

    public static int showTokenLimitExceededDialog() {
        return MessageDialogBuilder.okCancel(
                        AvatarBundle.get("dialog.tokenLimitExceeded.title"),
                        AvatarBundle.get("dialog.tokenLimitExceeded.description"))
                .yesText(AvatarBundle.get("dialog.continue"))
                .noText(AvatarBundle.get("dialog.cancel"))
                .icon(Icons.Default)
    ...
    public static int showTokenSoftLimitWarningDialog(int tokenCount) {
        return MessageDialogBuilder.okCancel(
                        AvatarBundle.get("dialog.tokenSoftLimitExceeded.title"),
                        format(AvatarBundle.get("dialog.tokenSoftLimitExceeded.description"), tokenCount))
                .yesText(AvatarBundle.get("dialog.continue"))
                .noText(AvatarBundle.get("dialog.cancel"))
                .icon(Icons.Default)
                .doNotAsk(new DoNotAskOption.Adapter() {
    ...
    public static void showSelectedEditorSelectionWarning(
        ...
        showWarningBalloon(
                CodeEditorHelper.fetchSelectedEditor(project) == null
