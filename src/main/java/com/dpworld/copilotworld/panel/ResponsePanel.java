  ...
  static class Header extends JPanel {
    ...
    public void addReloadAction(Runnable onReload) {
      addIconActionButton(new IconActionButton(
          new AnAction(
              AvatarBundle.get("toolwindow.chat.response.action.reloadResponse.text"),
              AvatarBundle.get("toolwindow.chat.response.action.reloadResponse.description"),
              Actions.Refresh) {
            @Override
    ...
    public void addDeleteAction(Runnable onDelete) {
      addIconActionButton(new IconActionButton(
          new AnAction(
              AvatarBundle.get("toolwindow.chat.response.action.deleteResponse.text"),
              AvatarBundle.get("toolwindow.chat.response.action.deleteResponse.description"),
              Actions.GC) {
            @Override
            public void actionPerformed(@NotNull AnActionEvent e) {
              onDelete.run();
